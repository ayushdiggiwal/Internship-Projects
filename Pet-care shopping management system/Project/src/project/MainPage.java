...
public class MainPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pet Care Shopping");
        ...
        electronicsButton.setText("Dogs");
        electronicsButton.setToolTipText("Food, Dental Care, Accessories");
        ...
        mobilesButton.setText("Cats");
        mobilesButton.setToolTipText("Food, Dental Care, Accessories available on store!");
        ...
        kidsButton.setText("Birds");
        kidsButton.setToolTipText("Food, Dental Care, Accessories and much more!");
